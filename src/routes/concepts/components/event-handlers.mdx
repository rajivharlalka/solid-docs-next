...
Event handlers are functions that are called in response to a specific event occurring in the browser, such as when a user clicks on an element.
...
**Note:** If you are using ESLint, you will get a _warning_ if you use lowercase.
