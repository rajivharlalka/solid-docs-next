...
This primitive can be especially useful with other Solid primitives, such as [`createResource`](/reference/createResource) and [`createSignal`](/reference/createSignal), which can create dynamic behaviours based on the route parameters.
